...
"use strict";function createDateObject(e,r,t){var o=getShortPeriodFormat(e),n=moment(r);return t&&setPeriodOnMoment(e,n,t),{key:n.format(o),value:n}}function getShortPeriodFormat(e){if("ytd"===e)return"[YTD] YY";switch(e[0]){case PERIOD_MODES.DAYS:return"DD.";case PERIOD_MODES.WEEKS:return"[KW] W YYYY";case PERIOD_MODES.MONTHS:return"MMMM YYYY";case PERIOD_MODES.QUARTERS:return"[Q.]Q YYYY";case PERIOD_MODES.HALF_YEAR:return"Q. [Halbjahr] YYYY";case PERIOD_MODES.YEARS:return"YYYY";case PERIOD_MODES.TOTAL:return"[Total]"}throw'No short period format found for "'+e+'"'}function getLongPeriodFormat(e){if("ytd"===e)return"[YTD] YYYY";switch(e[0]){case PERIOD_MODES.DAYS:return"DD.MM.YYYY";case PERIOD_MODES.WEEKS:return"[KW] W YYYY";case PERIOD_MODES.MONTHS:return"MMMM YYYY";case PERIOD_MODES.QUARTERS:return"[Q.]Q YYYY";case PERIOD_MODES.HALF_YEAR:return"Q. [Halbjahr] YYYY";case PERIOD_MODES.YEARS:return"YYYY";case PERIOD_MODES.TOTAL:return"[Total]"}throw'No long period format found for "'+e+'"'}function getPeriodGroupFormat(e){if("ytd"===e)return"[YTD] YYYY";switch(e[0]){case PERIOD_MODES.DAYS:return"DD. MMMM";case PERIOD_MODES.WEEKS:return"[KW] W GGGG";case PERIOD_MODES.MONTHS:return"MMMM YYYY";case PERIOD_MODES.QUARTERS:return"[Q%Q%] YYYY";case PERIOD_MODES.HALF_YEAR:return"[H%H%] YYYY";case PERIOD_MODES.YEARS:return"YYYY";case PERIOD_MODES.TOTAL:return"[Total]"}throw'No long period format found for "'+e+'"'}function getMomentSetterFunction(e){switch(e){case PERIOD_MODES.DAYS:return"date";case PERIOD_MODES.WEEKS:return"week";case PERIOD_MODES.MONTHS:return"month";case PERIOD_MODES.QUARTERS:return"quarter";case PERIOD_MODES.YEARS:return"year"}throw'No moment setter found for period "'+e+'"'}function isNewPeriodGroup(e,r){switch(e){case PERIOD_MODES.DAYS:return 1===r.date();case PERIOD_MODES.WEEKS:return 1===r.date();case PERIOD_MODES.MONTHS:case PERIOD_MODES.QUARTERS:return 1===r.dayOfYear();case PERIOD_MODES.YEARS:return!0}throw'No newGroup rule found for period "'+e+'"'}function getMomentRangeIterator(e){switch(e){case PERIOD_MODES.DAYS:return"days";case PERIOD_MODES.WEEKS:return"weeks";case PERIOD_MODES.MONTHS:return"months";case PERIOD_MODES.QUARTERS:return"quarters";case PERIOD_MODES.YEARS:return"years"}throw'No moment setter found for period "'+e+'"'}function setPeriodOnMoment(e,r,t){var o=getMomentSetterFunction(e);r[o](t)}function getNumberOfDaysInMonth(e,r){return new Date(e,r+1,0).getDate()}if(require){var moment=require("moment")||moment;require("moment-range")}var api,Period,PERIOD_MODES={DAYS:"d",WEEKS:"w",MONTHS:"m",QUARTERS:"q",HALF_YEAR:"h",YEARS:"y"};Period=function(e,r,t){this.periodMode=e,this.start=moment(r),this.end=moment(t),this.range=moment().range(r,t),this.values=null},Period.prototype.getLongPeriodLabel=function(){var e=this.getLongStringForStart(),r=this.getLongStringForEnd();return e+" - "+r},Period.prototype.isEqual=function(e){var r,t,o;return r=this.start.isSame(e.start),t=this.end.isSame(e.end),o=this.periodMode===e.periodMode,r&&t&&o},Period.prototype.getLongStringForStart=function(){return this.start.format(getLongPeriodFormat(this.periodMode))},Period.prototype.getLongStringForEnd=function(){return this.end.format(getLongPeriodFormat(this.periodMode))},Period.prototype.getLongStringFormat=function(){return getLongPeriodFormat(this.periodMode)},Period.prototype.getShortStringFormat=function(){return getShortPeriodFormat(this.periodMode)},Period.prototype.getGroupStringFormat=function(){return getPeriodGroupFormat(this.periodMode)},Period.prototype.getValueAsObjects=function(){if(null!==this.values)return this.values;var e=this,r=getMomentRangeIterator(this.periodMode);return this.values=[],this.range.by(r,function(r){r.isNewGroup=isNewPeriodGroup(e.periodMode,r),e.values.push(r)}),this.values},api={},api.createPeriod=function(e,r,t){return new Period(e,r,t)},api.PERIOD_MODES=PERIOD_MODES,api._getNumberOfDaysInMonth=getNumberOfDaysInMonth,api._setPeriodOnMoment=setPeriodOnMoment,api._isNewPeriodGroup=isNewPeriodGroup,module.exports=api;
},{"moment":3,"moment-range":2}],2:[function(require,module,exports){
!function(t,n){"object"==typeof exports?module.exports=n(require("moment")):"function"==typeof define&&define.amd?define(["moment"],n):t.moment=n(t.moment)}(this,function(t){var n,e;return e={year:!0,month:!0,week:!0,day:!0,hour:!0,minute:!0,second:!0},n=function(){function n(n,e){this.start=t(n),this.end=t(e)}return n.prototype.contains=function(t){return t instanceof n?this.start<=t.start&&this.end>=t.end:this.start<=t&&t<=this.end},n.prototype._by_string=function(n,e){var s,r;for(s=t(this.start),r=[];this.contains(s);)e.call(this,s.clone()),r.push(s.add(1,n));return r},n.prototype._by_range=function(n,e){var s,r,i,o;if(r=Math.floor(this/n),1/0===r)return this;for(o=[],s=i=0;r>=0?r>=i:i>=r;s=r>=0?++i:--i)o.push(e.call(this,t(this.start.valueOf()+n.valueOf()*s)));return o},n.prototype.overlaps=function(t){return null!==this.intersect(t)},n.prototype.intersect=function(t){var e,s,r,i,o,a,h,u;return this.start<=(s=t.start)&&s<(e=this.end)&&e<t.end?new n(t.start,this.end):t.start<(i=this.start)&&i<(r=t.end)&&r<=this.end?new n(this.start,t.end):t.start<(a=this.start)&&a<(o=this.end)&&o<t.end?this:this.start<=(u=t.start)&&u<(h=t.end)&&h<=this.end?t:null},n.prototype.subtract=function(t){var e,s,r,i,o,a,h,u;return null===this.intersect(t)?[this]:t.start<=(s=this.start)&&s<(e=this.end)&&e<=t.end?[]:t.start<=(i=this.start)&&i<(r=t.end)&&r<this.end?[new n(t.end,this.end)]:this.start<(a=t.start)&&a<(o=this.end)&&o<=t.end?[new n(this.start,t.start)]:this.start<(u=t.start)&&u<(h=t.end)&&h<this.end?[new n(this.start,t.start),new n(t.end,this.end)]:void 0},n.prototype.by=function(t,n){return"string"==typeof t?this._by_string(t,n):this._by_range(t,n),this},n.prototype.valueOf=function(){return this.end-this.start},n.prototype.toDate=function(){return[this.start.toDate(),this.end.toDate()]},n.prototype.isSame=function(t){return this.start.isSame(t.start)&&this.end.isSame(t.end)},n.prototype.diff=function(t){return null==t&&(t=void 0),this.end.diff(this.start,t)},n}(),t.fn.range=function(s,r){return s in e?new n(t(this).startOf(s),t(this).endOf(s)):new n(s,r)},t.range=function(t,e){return new n(t,e)},t.fn.within=function(t){return t.contains(this._d)},t});
...
//# sourceMappingURL=./dist/period.map.json