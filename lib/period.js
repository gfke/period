...
(function (root, factory) {
    ...
    Period.prototype.getChecksum = function () {
        var startCheckSum = this.start.format(checksumFormat),
            endCheckSum = this.end.format(checksumFormat);
    ...
    Period.prototype.getValueAsObjects = function () {
        ...
        currentRange.by(momentRangeIterator, function (momentToUse) {
            ...
            momentToUse.checksum = momentToUse.format(checksumFormat);
